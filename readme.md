...
- [error_details.proto](#error_details.proto)
    - [ErrorDetails](#dialog.ErrorDetails)
    - [ErrorDetails.Violation](#dialog.ErrorDetails.Violation)
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| violations | [ErrorDetails.Violation](#dialog.ErrorDetails.Violation) | repeated | Describes all rule violations. |
...
<a name="dialog.ErrorDetails.Violation"></a>

### ErrorDetails.Violation
A message type used to describe a single rule violation.


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| tag | [string](#string) |  | What exactly rule has been violated |
| argument | [string](#string) |  | Rule argument. The content depends on tag. Like if we violated the minimum length rule for a something this argument should contain min length value. |
| violationDescription | [string](#string) |  | Optional parameter to provide a server localized message if any. |
